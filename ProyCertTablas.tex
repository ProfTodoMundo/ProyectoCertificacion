...
\begin{figure}[h] % Opciones para el posicionamiento de la figura (h = aquí)
  \centering
  \includegraphics[width=0.45\textwidth]{grafico.pdf} % Nombre del archivo del gráfico y ancho relativo
  \caption{Descripción de tu gráfico.}
  \label{fig:grafico} % Etiqueta para hacer referencia al gráfico en el texto
\end{figure}
...
\begin{figure}[h] % Opciones para el posicionamiento de la figura (h = aquí)
  \centering
  \includegraphics[width=0.45\textwidth]{graficoCertificacionesUACManual.pdf} % Nombre del archivo del gráfico y ancho relativo
  \caption{Descripción de tu gráfico.}
  \label{fig:grafico} % Etiqueta para hacer referencia al gráfico en el texto
\end{figure}
...
\begin{figure}[h] % Opciones para el posicionamiento de la figura (h = aquí)
  \centering
  \includegraphics[width=0.45\textwidth]{graficoCertificacionesPlanteles.pdf} % Nombre del archivo del gráfico y ancho relativo
  \caption{Descripción de tu gráfico.}
  \label{fig:grafico} % Etiqueta para hacer referencia al gráfico en el texto
\end{figure}
