...
View(MPG)
#<<==>><<==>><<==>><<==<<==>><<==>><<==>><<==>><<==>><<==<<==>><<==>><<==>><<==>><<==>><<==<<==>><<==>>
ResProbCert1a    <- MPG[order(MPG$ProbCert1a,decreasing= TRUE), ];  
View(ResProbCert1a);    # si
#<<==>><<==>><<==>><<==<<==>><<==>><<==>><<==>><<==>><<==<<==>><<==>><<==>><<==>><<==>><<==<<==>><<==>>
...
summary(ResProbCert)
table_latex <- xtable(ResProbCert)
...
View(ResProbCert4)
ResProbCert4 <- ResProbCert4[,c(1,2)]; View(ResProbCert4);
